...
public class FollowersAdapter extends RecyclerView.Adapter<FollowersAdapter.FollwersVH> {
    private List<Student> students;
    private Context context;

    public FollowersAdapter(List<Student> students, Context context) {
    ...
    @NonNull
    @Override
    public FollwersVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.layout_st_item, parent, false);
        return new FollwersVH(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FollwersVH holder, int position) {
    ...
    public class FollwersVH extends RecyclerView.ViewHolder {
        @BindView(R.id.iv_st_layout_item_prf_pic)
        ImageView prfPic;
        @BindView(R.id.tv_st_layout_item_name)
        TextView name;

        public FollwersVH(@NonNull View itemView) {
            super(itemView);
